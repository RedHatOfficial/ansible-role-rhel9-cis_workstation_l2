...
Ansible Role for CIS Red Hat Enterprise Linux 9 Benchmark for Level 2 - Workstation  
...
Run `ansible-galaxy install RedHatOfficial.rhel9_cis_workstation_l2` to
download and install the role. Then, you can use the following playbook snippet to run the Ansible role:

    - hosts: all
      roles:
         - { role: RedHatOfficial.rhel9_cis_workstation_l2 }
